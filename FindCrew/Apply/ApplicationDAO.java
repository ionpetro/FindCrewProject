	...
	try {
		...
		ResultSet rs = stmt.executeQuery();
			...
			while (rs.next()) {
				...
				Application app = new Application( rs.getInt("applicationid"),
									rs.getInt("userid_app"), rs.getString("name"), rs.getString("surname"), rs.getString("profession"), rs.getString("availability"),
									rs.getInt("age"), rs.getString("country"), rs.getString("gender"), rs.getString("personal_information"),
									rs.getString("cv_education"), rs.getString("cv_experience"), rs.getString("languages"));
